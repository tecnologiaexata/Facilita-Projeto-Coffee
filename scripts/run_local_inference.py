...
def main() -> None:
    ...
    print(f"confidence={params['conf']}")
    print(f"iou={params['iou']}")
    print(f"max_det={params['max_det']}")
    print(f"class_agnostic_nms={params['agnostic_nms']}")
    print(f"max_candidates={params['max_candidates']}")
